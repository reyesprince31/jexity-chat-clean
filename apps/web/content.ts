/**
 * Shared content parsing utilities used by both the chat widget (Preact) and
 * the helpdesk dashboard (React). These helpers perform all string tokenization
 * and citation normalization so each UI can render identical output with its
 * preferred component tree.
 */
