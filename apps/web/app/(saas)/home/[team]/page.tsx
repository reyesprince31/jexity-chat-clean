  ...
  return (
    <>
      ...
      <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
        <DashboardContent team={team} organizationName={organization.name} />
      </div>
    </>
  );
}
...
function DashboardContent({ team, organizationName }: DashboardContentProps) {
